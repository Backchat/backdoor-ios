...
- (void)viewDidLoad
{
    ...
    [shareButton setBackgroundImage:[[UIImage imageNamed:@"fc_facebook_inactive"] resizableImageWithCapInsets:UIEdgeInsetsMake(10,10,10,10)] forState:UIControlStateNormal];
    [shareButton setBackgroundImage:[[UIImage imageNamed:@"fc_facebook_active"] resizableImageWithCapInsets:UIEdgeInsetsMake(10,10,10,10)] forState:UIControlStateNormal];
    ...
    */
    ...
    [tweetButton setBackgroundImage:[[UIImage imageNamed:@"fc_twitter_inactive"] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10)] forState:UIControlStateNormal];
    [tweetButton setBackgroundImage:[[UIImage imageNamed:@"fc_twitter_active"] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10)] forState:UIControlStateHighlighted];
    ...
    [gppButton setBackgroundImage:[[UIImage imageNamed:@"fc_gpp_inactive"] resizableImageWithCapInsets:UIEdgeInsetsMake(18, 18, 18, 18)] forState:UIControlStateNormal];
    [gppButton setBackgroundImage:[[UIImage imageNamed:@"fc_gpp_active"] resizableImageWithCapInsets:UIEdgeInsetsMake(18, 18, 18, 18)] forState:UIControlStateHighlighted];
